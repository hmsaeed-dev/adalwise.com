...
export const SERIES_LIST: Series[] = [
  {
    id: "surah-al-anam-exegesis",
    slug: "surah-al-anam-exegesis",
    title: "Surah al-An'am — Divine Justice and Ontological Order",
    urduTitle: "تفسیر سورۃ الانعام: عدلِ الہی اور نظامِ کائنات",
    description:
      "A comprehensive, verse-by-verse exegesis exploring the metaphysical grounding of divine justice, creation, and ethical responsibility.",
    category: "Tafsir",
    totalEpisodes: 32,
  },
  {
  ...
  },
  {
    ...
    title: "Foundations of Legal Methodology (Usul al-Fiqh)",
...
export const TOPICS_LIST: Topic[] = [
  { id: "balaghat", slug: "balaghat", name: "Balaghat & Rhetoric", urduName: "بلاغت و فصاحت" },
  { id: "contractual-equity", slug: "contractual-equity", name: "Contractual Equity", urduName: "عدل فی العقود" },
  { id: "sovereignty", slug: "sovereignty", name: "Sovereignty & Authority", urduName: "حاکمیت اور اقتدار" },
  { id: "divine-justice", slug: "divine-justice", name: "Divine Justice (Adl)", urduName: "عدلِ الٰہی" },
  { id: "ethics-of-dialogue", slug: "ethics-of-dialogue", name: "Ethics of Disagreement", urduName: "آدابِ اختلاف" },
  { id: "maslahah", slug: "maslahah", name: "Public Welfare (Maslahah)", urduName: "مصلحتِ عامہ" },
];
