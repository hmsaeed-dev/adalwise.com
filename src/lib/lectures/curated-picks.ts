...
export const CURATED_START_HERE_PICKS: CuratedPick[] = [
	...
	{
		id: "yt-6lOzG4pUxo4",
		youtubeId: "6lOzG4pUxo4",
		slug: "02a-special-slaves-of-rahman-quran-for-guidance-today",
		title: "Special Slaves of Rahman: Quran for Guidance Today",
		urduTitle: "عباد الرحمٰن کے خصائص: قرآن رہنمائے حیات",
		domainId: "civic-ethics",
		domainTitle: "Social & Family Ethics",
		durationFormatted: "59:33",
		durationSeconds: 3573,
		thesisBlurb:
			"A profound exposition of the defining qualities of Ibad-ur-Rahman (Servants of the Merciful) from Surah Al-Furqan, examining personal humility, nocturnal devotion, and ethical conduct in public life.",
	},
	{
		id: "yt-mVWbLcjlRag",
