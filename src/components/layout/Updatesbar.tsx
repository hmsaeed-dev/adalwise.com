    ...
    return (
        <aside
            ...
            className={cn(
                ...
                isTransparentHero
                    ? "bg-transparent text-brand-warm-white/80 border-b border-white/10 drop-shadow-sm"
                    : "bg-surface/90 backdrop-blur-xl text-brand-charcoal/80 border-b border-surface-container-high/40 shadow-[0_1px_4px_rgba(0,0,0,0.02)]",
            )}
        >
            {/* Edge Fade Gradients */}
            <div
