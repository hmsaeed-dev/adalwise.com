...
export function ArticlesHeader() {
	return (
		<section className="relative overflow-hidden pt-8 pb-10 px-gutter-mobile md:px-gutter-desktop  border-surface-container-highest/60 bg-gradient-to-b from-surface-container-low/70 via-surface to-surface">
			<div className="relative z-10 flex flex-col gap-space-sm max-w-container-max mx-auto">
				...
				<p className="font-body-lg text-[16px] sm:text-body-lg text-on-surface-variant max-w-2xl leading-relaxed">
					In-depth academic monographs on contractual equity,
					classical constitutionalism, and legal maxims.
				</p>
			</div>
		</section>
	);
