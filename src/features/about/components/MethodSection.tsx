...
export function MethodSection() {
	return (
		<section
			id="method"
			className="w-full bg-surface text-on-surface py-16 sm:py-20 md:py-24  border-surface-container-high/80 scroll-mt-20"
		>
			<div className="w-full max-w-container-max mx-auto px-gutter-mobile md:px-gutter-desktop">
				<div className="max-w-3xl">
					...
					<div className="mt-8 sm:mt-10 max-w-[65ch] font-serif text-lg sm:text-[19px] text-[#121915] leading-[1.8] space-y-6">
						<p>
							In classical Islamic thought, justice (<em>‘Adl</em>
							) and wisdom (<em>Hikmah</em>) were never understood
							as distinct pursuits. Justice without wisdom
							degenerates into mechanical formalism—enforcing the
							outward letter of law while extinguishing its moral
							purpose and human equity. Wisdom without justice
							degrades into unprincipled pragmatism—clever
							accommodation without ethical backbone.
						</p>
						<p>
							Adalwise exists to restore their union. We approach
							the Seerah not as a closed historical chronicle to
							be preserved with nostalgic reverence, but as an
							active, living methodology of statecraft, ethics,
							and civic reasoning capable of addressing modern
							constitutional, legal, and human dilemmas.
						</p>
					</div>
				</div>
			</div>
